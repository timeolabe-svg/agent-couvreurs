  ...
  <div style="max-width:600px;margin:0 auto">
    ...
    <div style="background:#1a1d27;border-radius:0 0 8px 8px;padding:24px">
      ...
      <div style="background:#161b22;border:1px solid #30363d;border-radius:6px;padding:16px;margin-bottom:16px">
        ...
        ${calendarEventUrl ? `<p style="margin:8px 0 0"><a href="${calendarEventUrl}" style="color:#22c55e;font-size:13px">Voir dans Google Calendar →</a></p>` : ''}
      ...
      <a href="${baseUrl}" style="display:inline-block;background:#22c55e;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600">Voir dans le dashboard →</a>
    </div>
  </div>
</body>
</html>`
