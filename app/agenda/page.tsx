    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <p className="text-[12px]" style={{ color: 'var(--color-muted)' }}>
          Semaine du 28 avril — 2 mai 2025
        </p>
      </div>
      ...
      <div className="flex-1 overflow-auto flex flex-col">
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex" style={{ borderBottom: '1px solid var(--color-border)' }}>
            ...
            {weekDays.map((d, i) => {
              const isToday = d.toDateString() === new Date('2025-04-28').toDateString()
              const hasRdv = d.toISOString().startsWith(rdv.date)
              return (
                <div
                  key={i}
      ...
      >
        <p className="text-[11px] font-medium mb-3" style={{ color: 'var(--color-muted)' }}>PROCHAIN RDV</p>
        <div
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[12px]" style={{ color: 'var(--color-muted)' }}>
              {rdvDate.toLocaleDateString('fr-FR', { weekday: 'long', day: 'numeric', month: 'long' })} a {rdv.time} · {rdv.duration} min
            </p>
          ...
          <div className="text-right flex-shrink-0">
            <p className="text-[11px]" style={{ color: 'var(--color-muted)' }}>Détecté depuis :</p>
            <p className="text-[11px] italic max-w-48 text-right mt-0.5" style={{ color: 'var(--color-muted-2)' }}>
