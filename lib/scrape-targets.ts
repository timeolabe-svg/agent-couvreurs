// Cibles de scraping partagées (secteurs BTP + villes France entière).
// Utilisé par le cron scrape-leads. L'email étant personnalisé avec la ville
// du prospect, le ciblage reste local pour chaque destinataire.
